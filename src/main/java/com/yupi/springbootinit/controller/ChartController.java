...
public class ChartController {
    ...
    public BaseResponse<BiResponse> genchartByAi(@RequestPart("file") MultipartFile multipartFile,
        ...
        //限流判断,每个用户一个限流器
        redisLimiterManager.doReteLimit("genChartByAi_" + loginUser.getId());
        ...
        ThrowUtils.throwIf(size > ONE_MB, ErrorCode.PARAMS_ERROR, "文件大于 1MB ");
        //校验文件后缀
        String suffix = FileUtil.getSuffix(originalFilename);
        final List<String> validFileSuffixLis = Arrays.asList("xls", "xlsx");
        ThrowUtils.throwIf(!validFileSuffixLis.contains(suffix), ErrorCode.PARAMS_ERROR, "非法文件后缀");
        //模型id
        final long modelId = CommonConstant.BI_MODEL_ID;
        //用户输入
...
//        chart.setChartData(csvData);
        ...
        //分库分表
        chartService.createTableChartExcel(csvData, chart.getId());
